...
extern void *mono_aot_module_MX3Hydration_iOS_info;
...
extern void *mono_aot_module_MX3Hydration_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;
extern void *mono_aot_module_Firebase_Xamarin_info;
...
extern void *mono_aot_module_JWT_info;
extern void *mono_aot_module_crypto_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_MX3Hydration_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_MX3Hydration_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_Xaml_info);
	mono_aot_register_module (mono_aot_module_Firebase_Xamarin_info);
	...
	mono_aot_register_module (mono_aot_module_JWT_info);
	mono_aot_register_module (mono_aot_module_crypto_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "MX3Hydration.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 4;
